...
var pheromoneBlockingTypes = ['DIRT', 'STONE', 'DOODAD', 'TURRET', 'STEEL', 'IRON'];
...
},{"../render/renderAgent":24,"../selectors/sprites":30,"../utils/vectors":37,"./makeEntity":12}],3:[function(require,module,exports){
'use strict';
...
},{"../selectors/sprites":30,"./makeEntity":12}],4:[function(require,module,exports){
'use strict';
...
},{"../render/renderAgent":24,"../utils/vectors":37,"./makeEntity.js":12}],6:[function(require,module,exports){
'use strict';
...
var render = function render(ctx, game, bullet) {
  ...
  var width = bullet.width,
      ...
      contPos = bullet.contPos,
      prevPositions = bullet.prevPositions;

  var position = contPos;
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"../selectors/sprites":30,"../simulation/actionQueue":31,"../utils/vectors":37,"./makeEntity":12}],7:[function(require,module,exports){
'use strict';
...
},{"../selectors/sprites":30,"./makeEntity":12}],8:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"../selectors/sprites":30,"../simulation/actionQueue":31,"./makeEntity":12}],10:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"../selectors/sprites":30,"../simulation/actionQueue":31,"../utils/vectors":37,"./makeEntity":12}],11:[function(require,module,exports){
'use strict';
...
},{"../selectors/sprites":30,"../utils/vectors":37,"./makeEntity.js":12}],12:[function(require,module,exports){
'use strict';
...
var _require5 = require('../render/renderAgent'),
    renderAgent = _require5.renderAgent;
...
var config = {
  ...
  isAgent: true,
  pickupTypes: ['FOOD', 'DIRT', 'TOKEN', 'DYNAMITE', 'COAL', 'IRON', 'STEEL'],
  blockingTypes: ['DIRT', 'AGENT', 'STONE', 'DOODAD', 'DYNAMITE', 'SABRE', 'MIG'],
...
var make = function make(game, position, playerID) {
  var theta = Math.PI * 0.9;
  var agent = _extends({}, makeEntity('MIG', position, config.width, config.height), deepCopy(config), {
...
var spriteRenderFn = function spriteRenderFn(ctx, game, jet) {
  var position = jet.position,
      width = jet.width,
      height = jet.height,
      theta = jet.theta;
  ...
  if (game.showForceVectors) {
    ...
    for (var force in forces) {
      var vec = jet[force];
      var _theta = vectorTheta(vec);
      var mag = Math.abs(magnitude(vec));
      ctx.save();
      ctx.rotate(_theta);
...
},{"../render/renderAgent":24,"../selectors/sprites":30,"../utils/helpers":35,"../utils/vectors":37,"./makeEntity":12}],14:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"../selectors/sprites":30,"../simulation/actionQueue":31,"../utils/vectors":37,"./makeEntity":12}],15:[function(require,module,exports){
'use strict';
...
},{"../render/renderAgent":24,"../utils/vectors":37,"./makeEntity.js":12}],16:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"../selectors/sprites":30,"../simulation/actionQueue":31,"./makeEntity":12}],17:[function(require,module,exports){
'use strict';
...
},{"../config":1,"./agent.js":2,"./background.js":3,"./base.js":4,"./basicTurret.js":5,"./bullet.js":6,"./dirt.js":7,"./doodad.js":8,"./dynamite.js":9,"./laser.js":10,"./laserTurret.js":11,"./mig.js":13,"./missile.js":14,"./missileTurret.js":15,"./nuke.js":16,"./sabre.js":18,"./stone.js":19,"./sun.js":20,"./token.js":21,"./turret.js":22}],18:[function(require,module,exports){
'use strict';
...
var make = function make(game, position, playerID) {
  var theta = Math.PI * 0.9;
  var agent = _extends({}, makeEntity('SABRE', position, config.width, config.height), deepCopy(config), {
    playerID: parseInt(playerID),
    prevHP: config.hp,
    prevHPAge: 0,
    theta: theta,
...
},{"../render/renderAgent":24,"../selectors/sprites":30,"../utils/helpers":35,"../utils/vectors":37,"./makeEntity":12}],19:[function(require,module,exports){
'use strict';
...
},{"../selectors/sprites":30,"./makeEntity":12}],20:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"./makeEntity":12}],21:[function(require,module,exports){
'use strict';
...
module.exports = { config: config, make: make, render: render };
},{"../config":1,"./makeEntity":12}],22:[function(require,module,exports){
'use strict';
...
},{"../render/renderAgent":24,"../selectors/sprites":30,"../utils/vectors":37,"./makeEntity.js":12}],23:[function(require,module,exports){
'use strict';
...
},{"./config":1,"./selectors/neighbors":28,"./selectors/pheromones":29,"./simulation/entityOperations":32,"./simulation/pheromones":33,"./utils/gridHelpers":34,"./utils/helpers":35,"./utils/stochastic":36,"./utils/vectors":37}],24:[function(require,module,exports){
'use strict';
...
},{"../utils/gridHelpers":34,"../utils/helpers":35,"../utils/vectors":37,"./renderHealthBar":25}],25:[function(require,module,exports){
'use strict';
...
},{"../utils/gridHelpers":34,"../utils/vectors":37}],26:[function(require,module,exports){
'use strict';
...
},{"../utils/gridHelpers":34}],27:[function(require,module,exports){
'use strict';
...
var canDoMove = function canDoMove(game, entity, nextPos) {
  ...
  if (!containsVector(freeInternalNeighbors, nextPos) && !equals(nextPos, entity.position) || collidesWith(game, _extends({}, entity, { position: nextPos }), blockers).length > 0) {
...
},{"../selectors/collisions":26,"../utils/gridHelpers":34,"../utils/vectors":37}],29:[function(require,module,exports){
'use strict';
...
},{"../config":1,"../selectors/neighbors":28,"../utils/gridHelpers":34,"../utils/helpers":35,"../utils/vectors":37}],30:[function(require,module,exports){
'use strict';
...
},{"../config":1,"../selectors/misc":27,"../selectors/neighbors":28,"../selectors/pheromones":29,"../simulation/actionQueue":31,"../utils/gridHelpers":34,"../utils/helpers":35,"../utils/vectors":37}],31:[function(require,module,exports){
'use strict';
...
},{"../selectors/pheromones":29,"../utils/helpers":35,"../utils/vectors":37}],32:[function(require,module,exports){
'use strict';
...
var removeEntity = function removeEntity(game, entity) {
  ...
  if (game.JET[entity.id]) {
    delete game.JET[entity.id];
  }
...
},{"../config":1,"../entities/makeEntity":12,"../entities/registry":17,"../selectors/neighbors":28,"../selectors/pheromones":29,"../simulation/pheromones":33,"../utils/gridHelpers":34,"../utils/helpers":35,"../utils/vectors":37}],33:[function(require,module,exports){
'use strict';
...
},{"../config":1,"../selectors/neighbors":28,"../selectors/pheromones":29,"../utils/gridHelpers":34,"../utils/helpers":35,"../utils/vectors":37}],34:[function(require,module,exports){
'use strict';
...
},{"../config":1,"../utils/helpers":35,"../utils/vectors":37}],35:[function(require,module,exports){
'use strict';
...
},{"./vectors":37}],36:[function(require,module,exports){
"use strict";
