...
function LevelEditor(props: Props): React.Node {
  ...
  const [editor, setEditor] = useState({
    ...
    // pheromone mode
    selectedPheromone: 'HEAT',
    pheromoneQuantity: globalConfig.pheromones.HEAT.quantity,
  });
    ...
    <div>
      ...
      <div>
        <Checkbox
          ...
          checked={!!state.game.showForceVectors}
          onChange={value=> dispatch({
            type: 'SET', property: 'showForceVectors', value,
          })}
        />
      </div>
      <div>
